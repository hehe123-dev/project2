...
var groupList = [
  { id: 1, name: '北理工人工智能校友会', logo: 'https://picsum.photos/seed/g1/200/200', category: '行业社团', leader: '赵明辉', phone: '138****0001', intro: '汇聚人工智能领域的北理工校友，定期举办技术交流、项目合作和人才对接活动。目前已有成员200余人，涵盖AI算法、芯片、应用等多个细分方向。', memberCount: 218, news: [{ id: 1, title: 'AI校友会春季技术交流会圆满举办' }, { id: 2, title: 'AI校友会赴商汤科技参观学习' }], activities: [{ id: 1, title: '大模型技术研讨会', date: '2026-06-20', location: '中关村软件园国际会议中心', description: '邀请业界大咖分享大模型最新技术进展与应用实践，设有圆桌讨论和自由交流环节，欢迎校友踊跃参加。' }, { id: 2, title: 'AI校友会春季户外团建', date: '2026-05-15', location: '奥林匹克森林公园', description: '春季户外团建活动，包含趣味运动、团队协作挑战和BBQ聚餐，增进校友感情。' }], members: [{ name: '赵明辉', avatar: 'https://picsum.photos/seed/m1/100/100', school: '自动化学院', year: '2005级', joinDate: '2025-03-01' }, { name: '张建国', avatar: 'https://picsum.photos/seed/u1/100/100', school: '自动化学院', year: '2005级', joinDate: '2025-03-10' }, { name: '李明远', avatar: 'https://picsum.photos/seed/u2/100/100', school: '计算机学院', year: '2008级', joinDate: '2025-06-15' }] },
  { id: 2, name: '北理工金融投资校友俱乐部', logo: 'https://picsum.photos/seed/g2/200/200', category: '行业社团', leader: '陈立', phone: '139****0002', intro: '由从事金融投资行业的校友发起，旨在搭建校友间的投融资对接平台。成员涵盖VC、PE、证券、银行等金融机构。', memberCount: 156, news: [{ id: 1, title: '2026年投资趋势研讨会成功举行' }], activities: [{ id: 1, title: '校友企业投融资对接会', date: '2026-07-08', location: '北京市朝阳区国贸三期', description: '为有融资需求的校友企业对接投资机构，提供路演展示和一对一交流机会，助力校友企业发展。' }, { id: 2, title: '二级市场投资沙龙', date: '2026-06-25', location: '金融街威斯汀酒店', description: '邀请券商首席分析师分享下半年投资策略，涵盖A股、港股和美股市场展望。' }], members: [{ name: '陈立', avatar: 'https://picsum.photos/seed/m2/100/100', school: '管理与经济学院', year: '2006级', joinDate: '2025-02-20' }] },
  { id: 3, name: '北理工北京校友足球队', logo: 'https://picsum.photos/seed/g3/200/200', category: '兴趣社团', leader: '孙磊', phone: '137****0003', intro: '热爱足球的北理工北京校友聚集地，每周组织训练和友谊赛。以球会友，锻炼身体，增进情谊。', memberCount: 68, news: [], activities: [{ id: 1, title: '友谊赛 vs 清华校友队', date: '2026-06-28', location: '北京理工大学中关村校区体育场', description: '一年一度的北理 vs 清华校友足球友谊赛，欢迎各位校友前来观赛助威！赛后安排聚餐交流。' }, { id: 2, title: '每周六常规训练', date: '2026-06-21', location: '奥体中心足球场', description: '每周六下午2-5点的常规训练，欢迎各水平的校友参加。新加入的校友请提前联系负责人。' }], members: [{ name: '孙磊', avatar: 'https://picsum.photos/seed/m3/100/100', school: '机械与车辆学院', year: '2007级', joinDate: '2024-09-01' }, { name: '王军', avatar: 'https://picsum.photos/seed/u4/100/100', school: '机械与车辆学院', year: '2010级', joinDate: '2024-10-15' }] },
  { id: 4, name: '北理工广东校友会', logo: 'https://picsum.photos/seed/g4/200/200', category: '地方社团', leader: '黄文杰', phone: '135****0004', intro: '广东地区北理工校友的联络平台，为在粤校友提供交流、互助和发展支持。定期组织企业走访、技术沙龙和联谊活动。', memberCount: 320, news: [], activities: [{ id: 1, title: '深圳校友企业走访——华为松山湖', date: '2026-07-15', location: '华为松山湖基地', description: '组织校友走访华为松山湖基地，参观华为研发中心，与华为校友进行技术交流与经验分享。名额有限，先到先得。' }], members: [{ name: '黄文杰', avatar: 'https://picsum.photos/seed/m4/100/100', school: '信息与电子学院', year: '2004级', joinDate: '2023-05-10' }, { name: '陈晓华', avatar: 'https://picsum.photos/seed/u2/100/100', school: '材料学院', year: '2006级', joinDate: '2024-01-20' }] }
];
...
var helpList = [
  { id: 1, title: '寻找新能源电池领域的技术合作伙伴', publisher: { name: '陈晓华', avatar: 'https://picsum.photos/seed/u2/100/100', role: '商务会员' }, date: '2026-06-08', description: '我们公司正在开发新一代储能电池管理系统，需要寻找在电池管理芯片或算法方面有技术积累的校友合作。最好在深圳或广州地区。', status: '未解决', responseCount: 3, responses: [{ name: '张建国', avatar: 'https://picsum.photos/seed/u1/100/100', text: '我在深圳认识几个做BMS的团队，可以帮忙牵线。', time: '2026-06-09' }, { name: '赵明辉', avatar: 'https://picsum.photos/seed/m1/100/100', text: '我们有一个储能方向的项目，可以聊一下合作。', time: '2026-06-10' }] },
  { id: 2, title: '求推荐靠谱的医疗器械注册代理机构', publisher: { name: '刘芳', avatar: 'https://picsum.photos/seed/u3/100/100', role: '商务会员' }, date: '2026-06-05', description: '公司有一款二类医疗器械需要注册，求推荐有经验的代理机构，最好在北京地区，有成功案例的优先。', status: '已解决', responseCount: 5, responses: [{ name: '李明远', avatar: 'https://picsum.photos/seed/u2/100/100', text: '我可以帮忙对接，我们公司之前合作过一个不错的代理机构，我发给你。', time: '2026-06-06' }] },
...
var courseList = [
  {
    id: 1, title: '企业数字化转型实战指南', subtitle: '从战略到落地，一站式掌握数字化转型方法论', cover: 'https://picsum.photos/seed/course1/750/420',
    teacher: '张建国', teacherAvatar: 'https://picsum.photos/seed/u1/200/200', teacherTitle: '智控科技创始人 · 北理工2005级',
  ...
  {
    id: 2, title: '创业者的财务管理课', subtitle: '让创业者真正读懂财务报表，做出明智决策', cover: 'https://picsum.photos/seed/course2/750/420',
    teacher: '陈立', teacherAvatar: 'https://picsum.photos/seed/u2/200/200', teacherTitle: '资深财务顾问 · 北理工2007级',
  ...
  {
    id: 3, title: 'AI产品经理入门到精通', subtitle: '抓住AI浪潮，从0到1打造爆款AI产品', cover: 'https://picsum.photos/seed/course3/750/420',
    teacher: '李明远', teacherAvatar: 'https://picsum.photos/seed/u3/200/200', teacherTitle: '字节跳动技术总监 · 北理工2008级',
...
var AppState = {
  ...
  collectedInterviews: {},
  collectedCourses: {},
  feedComments: { 1: [{ name: '赵明辉', avatar: 'https://picsum.photos/seed/m1/100/100', text: '张总说得太好了，为北理工自豪！', time: '2026-06-08 15:00' }], 2: [{ name: '王军', avatar: 'https://picsum.photos/seed/u3/100/100', text: '恭喜落地！期待合作。', time: '2026-06-07 11:00' }, { name: '刘芳', avatar: 'https://picsum.photos/seed/u3/100/100', text: '星辰科技的产品很赞！', time: '2026-06-07 12:30' }], 3: [{ name: '张建国', avatar: 'https://picsum.photos/seed/u1/100/100', text: '恭喜刘总！A轮5000万非常不错！', time: '2026-06-06 20:00' }] },
  groupBuyOrders: [1, 2],
  myFeeds: [1, 2, 3],
  myActivities: [1, 2],
  myTopics: [1],
...
var routes = [
  ...
  { path: '/service-provider/:id', view: 'ServiceProvider', meta: { minRole: '商务会员' } },
...
function UI_Button(text, type, size, round, block, color) {
  ...
  return '<button class="' + cls + '" style="' + style + '">' + escapeHtml(text) + '</button>';
}
